...
layout(location=4) in float in_outline_width;
layout(location=5) in vec4  in_shadow_color;
layout(location=6) in vec2  in_shadow_offset;

layout(location=0) out vec4  out_color;
layout(location=1) out vec2  out_uv;
layout(location=2) out vec4  out_outline_color;
layout(location=3) out float out_outline_width;
layout(location=4) out vec4  out_shadow_color;
layout(location=5) out vec2  out_shadow_offset;
